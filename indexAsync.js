...
// dùng bộ: class + promise + fetch
    ...
    //class chứa các hàm dùng render cho UI
        class RenderUI {
...
//sự kiện thay đổi province:
    document.querySelector("#province").addEventListener("change", async(value) => {
...
//sự kiện thay đổi district:
    document.querySelector("#district").addEventListener("change", async (value) => {
